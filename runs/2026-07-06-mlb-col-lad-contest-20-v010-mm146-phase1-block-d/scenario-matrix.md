...
| --- | --- | --- | --- | --- |
| target-preflight | Target preflight and allowlist | pass | raw/target-preflight.sanitized.json | COL @ LAD contest 20 and specs 48, 49, 50 passed identity, verification, odds, and allowlist gates. |
