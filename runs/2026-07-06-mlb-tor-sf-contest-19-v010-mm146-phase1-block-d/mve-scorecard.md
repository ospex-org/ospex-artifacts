...
| --- | --- | --- | --- | --- |
| target-preflight | Target preflight and allowlist | proven_live | raw/target-preflight.sanitized.json | TOR @ SF contest 19 and specs 45, 46, 47 passed identity, verification, odds, and allowlist gates. |
