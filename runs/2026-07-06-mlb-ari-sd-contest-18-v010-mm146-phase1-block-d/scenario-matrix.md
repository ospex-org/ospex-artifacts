...
| --- | --- | --- | --- | --- |
| target-preflight | Target preflight and allowlist | pass | raw/target-preflight.sanitized.json | ARI @ SD contest 18 and specs 42, 43, 44 passed identity, verification, odds, and allowlist gates. |
