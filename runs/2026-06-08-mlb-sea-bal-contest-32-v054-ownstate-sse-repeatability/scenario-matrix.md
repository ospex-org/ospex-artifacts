...
| `postgame-lifecycle` | Postgame score/settle/claim lifecycle | `pending` | `evidence.json` | Not attempted in Phase 2 by design; required before artifact can be upgraded from partial. |
